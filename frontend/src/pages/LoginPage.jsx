  ...
  return (
    ...
    <div className="h-screen overflow-hidden grid lg:grid-cols-2 bg-[#0a0a12] pt-[60px]">
      ...
      <div className="relative flex flex-col justify-center items-center overflow-hidden px-6 py-8 sm:px-12">
        ...
        {/* Frosted glass card */}
        <div className="relative z-10 w-full max-w-md rounded-2xl p-6 sm:p-8" style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Email */}
            <div>
              <label className="block text-xs font-medium tracking-widest mb-1.5" style={{ color: "rgba(255,255,255,0.5)" }}>
                EMAIL
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2.5 rounded-xl text-sm text-white placeholder:text-white/25 outline-none transition-all"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-9 pr-10 py-2.5 rounded-xl text-sm text-white placeholder:text-white/25 outline-none transition-all"
                  style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.12)" }}
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl text-white text-sm font-semibold flex items-center justify-center gap-2 transition-all hover:opacity-90 disabled:opacity-60"
